...
Execute unit tests
```
    cd "CryptoWallet.Notification.Lambda/test/CryptoWallet.Notification.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CryptoWallet.Notification.Lambda/src/CryptoWallet.Notification.Lambda"
